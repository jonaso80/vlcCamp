    ...
    <footer className="bg-slate-800 text-slate-300 mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-1 [&_.text-slate-700]:text-slate-300">
            <Logo width={48} height={48} className="mb-3" />
            <h3 className="text-white font-semibold text-lg mb-2">{t('footer.aboutUs')}</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+34123456789" className="text-slate-400 hover:text-[#8EB8BA] transition-colors text-sm">
                  {t('footer.contact')}
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 mt-0.5 text-[#8EB8BA]">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                </span>
                <a href="mailto:info.campvlc@gmail.com" className="text-slate-400 hover:text-[#8EB8BA] transition-colors break-all">
                  info.campvlc@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 text-[#8EB8BA]">
                  <PhoneIcon />
                </span>
                <a href="tel:+34123456789" className="text-slate-400 hover:text-[#8EB8BA] transition-colors">
                  +34 123 456 789
                </a>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                ...
                className="text-slate-400 hover:text-[#8EB8BA] transition-colors p-1.5 rounded-lg hover:bg-slate-700/50"
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-slate-400 hover:text-[#8EB8BA] transition-colors text-sm">
